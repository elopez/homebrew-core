class SlitherAnalyzer < Formula
  ...
  resource "eth-typing" do
    url "https://files.pythonhosted.org/packages/00/0f/45bcc747cb1f348f7d4a51ff1a49450f4e3ff1e1a4ab055ea15f4b486972/eth-typing-3.5.0.tar.gz"
    sha256 "a92f6896896752143a4704c57441eedf7b1f65d5df4b1c20cb802bb4aa602d7e"
  end

  resource "eth-utils" do
    url "https://files.pythonhosted.org/packages/70/1f/b112416a32cae14cf986f22f85abcccec54054d3d4c699ce831faaf7bf37/eth-utils-2.2.2.tar.gz"
    sha256 "5ca6265177ce544d9d43cdf2272ae2227e5d6d9529c270bbb707d17339087101"
  end
  ...
  resource "web3" do
    url "https://files.pythonhosted.org/packages/54/4d/720345f2dd680d7fdebbbce91a22f3db0f068e931e0969ecc16014e9fe4a/web3-6.11.0.tar.gz"
    sha256 "050dea52ae73d787272e7ecba7249f096595938c90cce1a384c20375c6b0f720"
  end
